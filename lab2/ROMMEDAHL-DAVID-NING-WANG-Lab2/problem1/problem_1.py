...
# This is the main file used to train, evaluate and compare networks using DQN.
...
# The final network, which is called 'neural-network-1.pth', is an instance of the NeuralNet class.
# It is a copy of the network with the same name in the Networks folder.
# DQN_check_solution_david.py is a version of DQN_check_solution.py which makes the functionality into a function,
# to export the results and include in the networks_parameters.txt dictionary in the Networks folder.
# You can either check our network using this file, by running it as described earlier, or you can use the usual
# DQN_check_solution.py file.
...
import os.path
import json
from DQN_check_solution_david import check_solution
